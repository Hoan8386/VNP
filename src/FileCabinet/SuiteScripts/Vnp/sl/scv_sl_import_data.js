 ...
 */
define(['N/query', 'N/runtime', 'N/url', '../common/scv_common_import_data.js'],
    ...
    (query, runtime, url, commonData) => {
        ...
        const getProcessUrl = () => url.resolveScript({
            scriptId: 'customscript_scv_sl_import_data_process',
            deploymentId: 'customdeploy_scv_sl_import_data_process'
        });
            ...
            *{box-sizing:border-box;margin:0;padding:0}
            ...
            window.postData = function() {
              ...
              if (!subsidiary) {
                ...
                alert('Vui lòng chọn subsidiary trước khi import dữ liệu.');
                return;
              }
              ...
              // Disable nút trước khi import để tránh bấm nhiều lần
              if (b) { b.disabled = true; b.style.opacity = '0.6'; b.style.cursor = 'not-allowed'; b.textContent = 'Importing...'; }
              ...
              .catch(function(e) {
                ...
                alert('Import dữ liệu thất bại: ' + (e.message || e));
                resetBtn('Lỗi ✕');
              });
            };
