    ...
    (cmVendorCredit) => {
        ...
        const beforeLoad = (scriptContext) => {
            try {
                ...
                // Add button theo record type nằm ở ../common/scv_common_vendor_credit.js.
                // Vendor Prepayment chưa có handler riêng -> tự rơi vào addButtonJournalOnly (chỉ Create/Update JRL).
